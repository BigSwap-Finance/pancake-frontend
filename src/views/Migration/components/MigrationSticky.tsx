...
const MigrationSticky: React.FC<MigrationStickyProps> = ({ step, handleClick }) => {
  ...
  const title: string = isStep1 ? t('Unstaking LP Tokens and BGSP') : t('Stake in the new contract.')
  const subTitle: string = isStep1
    ? t('All the earned BGSP will be harvested to your wallet upon unstake.')
