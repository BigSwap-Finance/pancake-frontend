...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and BGSP pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and BGSP pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from BGSP pool', data)
  }
