...
export const DEFAULT_META: PageMeta = {
  title: 'BigSwap',
  description:
    'The most popular AMM on BSC by user count! Earn BGSP through yield farming or win it in the Lottery, then stake it in Big Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by BigSwap), NFTs, and more, on a platform you can trust.',
